...
import { FaSignInAlt, FaGraduationCap, FaEnvelope, FaLock, FaTimes, FaUserCheck } from "react-icons/fa";
          ...
          <div className="glass-panel w-full max-w-md p-6 rounded-3xl border border-slate-200 bg-white space-y-5 shadow-2xl relative">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-lg font-bold text-slate-900 font-outfit">Sign in with Google</h3>
              </div>
            ...
            <p className="text-xs text-slate-600">Select a Google Account to continue to OpportunityBridge:</p>
