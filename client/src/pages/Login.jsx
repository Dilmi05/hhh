...
import { FaSignInAlt, FaGraduationCap, FaEnvelope, FaLock, FaTimes, FaUserCheck, FaArrowRight } from "react-icons/fa";
...
export default function Login() {
  ...
  const executeGoogleLogin = async (selectedEmail, selectedName) => {
    ...
    // Auto-generate name from email prefix if name is omitted
    const finalName =
      selectedName?.trim() ||
      selectedEmail
        .split("@")[0]
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          <div className="glass-panel w-full max-w-md p-6 rounded-3xl border border-slate-200 bg-white space-y-5 shadow-2xl relative animate-fadeIn">
            ...
            <p className="text-xs text-slate-600">
              Enter your Google email to authenticate on this device and link your OpportunityBridge profile:
            </p>
